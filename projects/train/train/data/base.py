...
class BaseAframeDataset(pl.LightningDataModule):
    ...
    def sample_length(self) -> float:
        ...
        return (
            self.hparams.windowing.kernel_length
    ...
    def left_pad_size(self) -> int:
        ...
        """
        return (
            int(self.hparams.windowing.left_pad * self.hparams.sample_rate)
            + self.filter_size // 2
        )
    ...
    def right_pad_size(self) -> int:
        ...
        """
        return (
            int(self.hparams.windowing.right_pad * self.hparams.sample_rate)
            + self.filter_size // 2
        )
    ...
    def slice_waveforms(self, waveforms: torch.Tensor) -> torch.Tensor:
        ...
        kernel_size = (
            int(
                self.hparams.windowing.kernel_length * self.hparams.sample_rate
            )
            + self.filter_size
        )
    ...
    def build_transforms(self):
        ...
        """
        window_length = (
            self.hparams.windowing.kernel_length + self.hparams.fduration
        )
    ...
    def setup(self, stage: str) -> None:
        ...
        self._logger.info(str(self.hparams.windowing))
