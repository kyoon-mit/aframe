#!/bin/bash
#SBATCH --job-name=gen_train_waveforms
...
#SBATCH --output=/n/holystore01/LABS/iaifi_lab/Lab/kyoon/DATA/aframe_data/slurm_logs/slurm-gen_train-%j.out
#SBATCH --error=/n/holystore01/LABS/iaifi_lab/Lab/kyoon/DATA/aframe_data/slurm_logs/slurm-gen_train-%j.err

# Submit with:  sbatch containers/gen_train.sh
...
singularity run \
    ...
    --right_pad 2 \
    --pool ${POOL} \
    --output_file /n/holystore01/LABS/iaifi_lab/Lab/kyoon/DATA/aframe_data/train/end_o3_ratesandpops_bns.hdf5
    # --output_file /n/holystore01/LABS/iaifi_lab/Lab/kyoon/aframe/dev/slurm/data/train/end_o3_ratesandpops_bns.hdf5
